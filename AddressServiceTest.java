...
//    positive test case to insert a record
    ...
    private void testCreateRecord_positive(String street, String city, long pincode, long expectedResult) {

        try{
            long actualResult = addressService.createRecord(street, city, pincode);
    ...
    private Object[][] testCreateRecord_positiveDP() {
        ...
        return new Object[][] {
            {"Mint street", "Madras", 600235, 10953},
            {"Ranganathan street", "Madras", 689752, 10954}
        };
    }
...
//  positive case to read all record using id
    ...
    private void testReadAllRecord_positive(String tableName, String expectedResult) {
      ...
      try {
          String actualResult = addressService.readAllRecords(tableName);
          Assert.assertEquals(actualResult, expectedResult);
      } catch (Exception e) {
          Assert.fail("Unexpected Exception for the given input.Expected result is " + expectedResult + e);
      }
    ...
    private Object[][] testReadAllRecord_positiveDP() {
      ...
      return new Object[][] {
          {"address", "[10901Perumal koil StreetCoimbatore600133, 10953Mint streetMadras600235, 10954Ranganathan streetMadras689752]"}
      };
    }
